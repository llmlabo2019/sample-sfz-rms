    ...
    <div className="room">
      ...
      <div className="room__lower">
        ...
        <div className="room__lower__left">
          <div
            className={`inditem inditem--status${
              systemStatus.status === "alarm"
                ? " inditem--status--alarm"
                : systemStatus.status === "stop"
                ? " inditem--status--stop"
                : ""
            }`}
          >
        ...
        <div className="room__lower__right">
          <div className="package">
            <div className="package__left">
              <div
                className={`inditem inditem--status${
                  coolerOneStatus.status === "stop"
                    ? " inditem--status--stop"
                    : ""
                }`}
              >
                <div className="inditem__title">No.1ステータス</div>
          ...
          <div className="package">
            <div className="package__left">
              <div
                className={`inditem inditem--status${
                  coolerTwoStatus.status === "stop"
                    ? " inditem--status--stop"
                    : ""
                }`}
              >
                <div className="inditem__title">No.2ステータス</div>
