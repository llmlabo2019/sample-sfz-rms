...
function Menu({ isMenuOpen, onCloseMenu, onSignOut }: Props) {
  ...
  return (
    <div className={isMenuOpen ? 'slider on' : 'slider'}>
      <div className="slider__item" onClick={() => handleMenuItemSelect('ダッシュボード')}>
        <Link href="/dashboard">
          <p>
      ...
      <div className="slider__item" onClick={() => handleMenuItemSelect('システム')}>
        <Link href="/datas/sf-zero-1">
          <p>
